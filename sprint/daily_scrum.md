...
- Chrisina: Done with the issue, improved the deadine fetures by adding input validation, program now only accepts dates in the format yyy-mm-dd and rejects invalid or past dates. Updated the mark completed features to use task index insted of title. All issue done.
